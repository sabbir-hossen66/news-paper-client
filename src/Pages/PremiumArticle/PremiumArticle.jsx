        ...
        <div className="flex flex-col items-center justify-center h-96 my-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-4">
            <div className="bg-gray-800 shadow-md rounded-lg p-6 text-center transform transition-transform hover:scale-105 hover:shadow-xl text-white">
              ...
              <h2 className="text-2xl font-bold mb-2 mt-4 text-blue-400">American News</h2>
              <p className="text-gray-400 text-lg mb-4">Usually, the paper is divided into sections for each of those major groupings (labelled A, B, C, and so on, with pagination prefixes yielding page numbers A1-A20, B1-B20, C1-C20, and so on). Most traditional papers also feature an editorial page containing editorials written by an editor (or by the papers editorial board) and expressing an</p>
              <p className="text-gray-400 text-lg mb-4">Publisher: somokal</p>
            ...
            <div className="bg-gray-800 shadow-md rounded-lg p-6 text-center transform transition-transform hover:scale-105 hover:shadow-xl text-white">
              ...
              <h2 className="text-2xl font-bold mb-2 mt-4 text-green-400">Paris Gotta</h2>
              <p className="text-gray-400 text-lg mb-4">Usually, the paper is divided into sections for each of those major groupings (labelled A, B, C, and so on, with pagination prefixes yielding page numbers A1-A20, B1-B20, C1-C20, and so on). Most traditional papers also feature an editorial page containing editorials written by an editor (or by the papers editorial board) and expressing an</p>
              <p className="text-gray-400 text-lg mb-4">Publisher: Prothom alo</p>
              <div className="flex justify-between items-center">
            ...
            <div className="bg-gray-800 shadow-md rounded-lg p-6 text-center transform transition-transform hover:scale-105 hover:shadow-xl text-white relative">
              ...
              <p className="text-gray-400 text-lg mb-4">Usually, the paper is divided into sections for each of those major groupings (labelled A, B, C, and so on, with pagination prefixes yielding page numbers A1-A20, B1-B20, C1-C20, and so on). Most traditional papers also feature an editorial page containing editorials written by an editor (or by the papers editorial board) and expressing an</p>
              <p className="text-gray-400 text-lg mb-4">Publisher: daily star</p>
              <div className="flex justify-between items-center">
                <span className="bg-green-500 text-white py-1 px-3 rounded-full text-xs"># International</span>
                <button className="bg-purple-500 text-white py-1 px-3 rounded-full text-xs">Details</button>
              </div>
