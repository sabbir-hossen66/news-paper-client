      ...
      <div>
        <section className="flex items-center h-full sm:p-16 dark:bg-gray-50 dark:text-gray-800">
          ...
          <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
            <Lottie className='hover:animate-spin' animationData={animation} />
            ...
            <a rel="noopener noreferrer" href="/" className="bg-gradient-to-r from-[#2784F5] to-[#28AFFC] hover:bg-gradient-to-r hover:from-cyan-500 hover:to-blue-500 py-4 px-12 text-white rounded-sm border-none font-medium shadow-xl font-sans">Back to homepage</a>
          </div>
        </section>
      </div>
    </div>
